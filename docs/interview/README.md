...
| 模块 | 题数 | 入口 |
|------|------|------|
| 01 并发与运行时 | 20 | [01-runtime-concurrency/](01-runtime-concurrency/) |
| 02 内存与 GC | 15 | [02-memory-gc/](02-memory-gc/) |
| 03 系统设计 | 20 | [03-system-design/](03-system-design/) |

## 中间件与数据库（19 题）

见 **[middleware/](middleware/)** 目录：MySQL(5)、Redis(3)、Kafka(1)、RocketMQ(3)、ES(3)、分布式事务(1)。
...
| **10 AI 工程与编程** | **8** | [**10-ai-engineering/**](10-ai-engineering/) |
| **11 解决方案架构** | **8** | [**11-solution-architecture/**](11-solution-architecture/) |
| **12 区块链与 Web3** | **6** | [**12-blockchain-web3/**](12-blockchain-web3/) |
