...
见 **[middleware/](middleware/index.md)** 目录：MySQL(5)、Redis(3)、Kafka(1)、RocketMQ(3)、ES(3)、分布式事务(1)。

## 其他模块

| 模块 | 题数 | 入口 |
|------|------|------|
| 06 网络与服务治理 | 5 | [06-network-governance/](06-network-governance/index.md) |
| **10 AI 工程与编程** | **8** | [**10-ai-engineering/**](10-ai-engineering/index.md) |
| **11 解决方案架构** | **8** | [**11-solution-architecture/**](11-solution-architecture/index.md) |
| **12 区块链与 Web3** | **9** | [**12-blockchain-web3/**](12-blockchain-web3/index.md) |
| **13 Solidity 与合约** | **8** | [**13-solidity-contracts/**](13-solidity-contracts/index.md) |
| **14 DEX / CEX 交易所** | **9** | [**14-dex-cex-engineering/**](14-dex-cex-engineering/index.md) |
| 08 手写题 | 5 | [08-coding-senior/](08-coding-senior/index.md) |
| 07 工程与领导力 | 3 | [07-engineering-leadership/](07-engineering-leadership/index.md) |
| 09 云原生 | 8 | [09-cloud-native/](09-cloud-native/index.md) |

## 高频 Top 10

1. [S-CONC-01 GMP](01-runtime-concurrency/S-CONC-01-gmp-overview.md)
2. [S-CONC-05 Channel](01-runtime-concurrency/S-CONC-05-channel.md)
...
题单元数据：[questions.yaml](_meta/questions.yaml)
