...
| [S-LEAD-03](./S-LEAD-03-code-review-culture.md) | 带团队与 Code Review | ⭐⭐⭐⭐ |

## 面试提示

- 用 **STAR** 准备 2～3 个真实案例（P0 事故、重构还债、带人成长）
- 少讲空话，多讲 **可量化结果**（MTTR、复发率、PR cycle time）
- 与 [03 系统设计](../03-system-design/S-ARCH-16-observability.md) 可观测性题联动
