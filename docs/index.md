...
!!! note "能力自检快链（可选）"
    ...
    [① 选方向与 P0](topics/_meta/role-priority-matrix.md) →
    [② 18 个高频锚点](high-frequency-roadmap.md) →
    [③ 岗位 P0 图谱](topics/_meta/p0-knowledge-graph.md) →
    [④ 专题自测](topic-quiz.md)
...
[查看七类方向完整 P0/P1/P2 与证据标签](topics/_meta/role-priority-matrix.md)
...
| **系统与组织架构** | [03 系统设计](topics/03-system-design/index.md) → [09 云原生](topics/09-cloud-native/index.md) → [11 解决方案架构](topics/11-solution-architecture/index.md) → [15 微服务](topics/15-microservices-exchange/index.md) → [07 领导力](topics/07-engineering-leadership/index.md) | 架构白板、K8s、演进、迁移与 Staff 影响力 |
