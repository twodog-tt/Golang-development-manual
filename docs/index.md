...
| 多链钱包与托管签名 | [17](topics/17-multichain-wallet/index.md) · [S-BC-10](topics/12-blockchain-web3/S-BC-10-mpc-tss-custody.md) | Adapter、充提归集、MPC/HSM、恢复 |
| 支付与账本 | [18](topics/18-web3-payments-stablecoin/index.md) | 支付状态机、清结算、合规边界 |
| 节点、RPC 与 Indexer | [19](topics/19-node-rpc-staking/index.md) · [S-BC-05](topics/12-blockchain-web3/S-BC-05-indexer-reorg.md) | 扫块、reorg、canonical、交易管理 |
| 交易所与协议 | [14](topics/14-dex-cex-engineering/index.md) · [13](topics/13-solidity-contracts/index.md) | CEX/DEX 资金与协议、行情、对账 |
| AI / Crypto Agent | [10](topics/10-ai-engineering/index.md) | 可审计工作流、互操作、执行边界 |
