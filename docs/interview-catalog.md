...
> 左侧导航按 **基础 → 进阶 → 高阶 → 专题 → 综合** 组织；本题单为速查表。  
> **⭐ 岗位定向**：[Web3 交易所重点准备](resume-focus-web3.md)
...
| 中间件与数据库 | 21 | [middleware/](interview/middleware/index.md) |

中间件子目录：MySQL(5)、Redis(3)、Kafka(4)、RocketMQ(4)、RabbitMQ(1)、ES(3)、分布式事务(1)。
...
| 模块 | 题数 | 入口 |
|------|------|------|
| 12 区块链与 Web3 | 10 | [12-blockchain-web3/](interview/12-blockchain-web3/index.md) |
