...
本轮目标不是扩充题量，而是避免把实现细节说成规范保证、把业务风险阈值说成协议
...
再补充 DEX Tech Lead P0（Staking/Farm、Uniswap V2/V3、45min 白板）、Gas/Fee 多链计费篇（S-BC-13）、
经典共识对照（S-PROTO-05）、EVM 公链全景（S-BC-14）及公链核验/交易最终性/RPC 恢复
（S-BC-15~17）补充后，当前为 **238 篇正文**。
