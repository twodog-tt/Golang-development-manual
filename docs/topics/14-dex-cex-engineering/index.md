...
31 篇 | P0/P1 专题（**预测市场 / 交易所 / DEX Tech Lead / 做市 / 合约后端 / 架构师** JD） | [返回专题索引](../../topic-catalog.md) · [重点专题](../../web3-exchange-wallet-focus.md)
...
| [S-EXCH-31](./S-EXCH-31-dex-tech-lead-whiteboard.md#oral-card) | **DEX Tech Lead 45 分钟架构白板** | ⭐⭐⭐⭐⭐ |
...
| [S-EXCH-29](./S-EXCH-29-defi-staking-liquidity-mining-yield.md#oral-card) | **DeFi Staking / 流动性挖矿 / Yield Farming** | ⭐⭐⭐⭐⭐ |
...
**DEX Tech Lead**：**EXCH-31** → **30** → **29** → 06/27 → 07/08 → 14 → SOLID-02/04/06/07 → BC-05/07/08 → LEAD-01/03/04

**交易系统后端**：**EXCH-17~22** → EXCH-16 → EXCH-04 → EXCH-01 → EXCH-03

**Web3 后端**：EXCH-14 → **30/27** → **29** → **23~26** → 10/11/12 → BC-05 → SOLID-04/08

## 岗位自测

- **CEX 后端**：能讲清撮合、账务、充提、强平四条链路
- **DEX 协议**：能画 AMM、讲清 LP 风险与 Oracle
- **DEX Tech Lead**：能在 **45 分钟**讲清协议权威、激励会计、链下投影、多链门禁与带队机制（EXCH-31/30/29）
