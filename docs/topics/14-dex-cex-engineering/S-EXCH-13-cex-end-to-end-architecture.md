...
2. **为什么**：交易所后端需要能 **串起 EXCH-01/02/03/05/11/15** 与 **MSVC 微服务拆分**，并讲清一致性边界、故障域与容量估算。
...
**一句话结论**：撮合日志权威记录订单执行；账务流水权威记录资产；行情与审计从
...
**讲解结论**：WS fan-out、账务热点和单个热门 order book 都可能成为瓶颈。
