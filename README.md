...
| [14 DEX / CEX 交易所工程](./docs/interview/14-dex-cex-engineering/index.md) | 31 | AMM/Uniswap/Pancake、Staking/Farm、DEX TL 白板、撮合/WAL、预测市场 |
...
| 3 | `S-CONC-03` | [Goroutine 栈增长与 OS 线程栈对比](./docs/interview/01-runtime-concurrency/S-CONC-03-goroutine-stack.md) |
| 4 | `S-CONC-04` | [GOMAXPROCS 调优与容器环境](./docs/interview/01-runtime-concurrency/S-CONC-04-gomaxprocs.md) |
| 5 | `S-CONC-05` | [Channel 内部实现与有缓冲/无缓冲选型](./docs/interview/01-runtime-concurrency/S-CONC-05-channel.md) |
| 6 | `S-CONC-06` | [Channel 死锁场景与排查](./docs/interview/01-runtime-concurrency/S-CONC-06-channel-deadlock.md) |
| 7 | `S-CONC-07` | [select 语义、公平性与 default 陷阱](./docs/interview/01-runtime-concurrency/S-CONC-07-select.md) |
| 8 | `S-CONC-08` | [Mutex、RWMutex 与 atomic 选型](./docs/interview/01-runtime-concurrency/S-CONC-08-sync-primitives.md) |
| 9 | `S-CONC-09` | [sync.Map 适用场景与误用](./docs/interview/01-runtime-concurrency/S-CONC-09-sync-map.md) |
| 10 | `S-CONC-10` | [sync.Pool 与 GC 交互](./docs/interview/01-runtime-concurrency/S-CONC-10-sync-pool.md) |
| 11 | `S-CONC-11` | [WaitGroup、Once 与 Cond](./docs/interview/01-runtime-concurrency/S-CONC-11-waitgroup-once-cond.md) |
| 12 | `S-CONC-12` | [Context 树、取消传播与泄漏](./docs/interview/01-runtime-concurrency/S-CONC-12-context.md) |
...
| 15 | `S-CONC-15` | [Race Detector 原理与工程实践](./docs/interview/01-runtime-concurrency/S-CONC-15-race-detector.md) |
| 16 | `S-CONC-16` | [Worker Pool 设计模式](./docs/interview/01-runtime-concurrency/S-CONC-16-worker-pool.md) |
| 17 | `S-CONC-17` | [Fan-out/Fan-in 与 Pipeline 模式](./docs/interview/01-runtime-concurrency/S-CONC-17-pipeline.md) |
| 18 | `S-CONC-18` | [Goroutine 泛滥治理与并发预算](./docs/interview/01-runtime-concurrency/S-CONC-18-goroutine-governance.md) |
| 19 | `S-CONC-19` | [Netpoller 与阻塞 Syscall 行为](./docs/interview/01-runtime-concurrency/S-CONC-19-netpoller.md) |
| 20 | `S-CONC-20` | [Go 1.22 循环变量与 Go 1.26 泛型演进](./docs/interview/01-runtime-concurrency/S-CONC-20-go122-generics.md) |
...
| 38 | `S-GOENG-03` | [Go 单元测试：表驱动、子测试与 Test Double](./docs/interview/16-go-production-engineering/S-GOENG-03-testing-table-fake.md) |
| 39 | `S-GOENG-04` | [Fuzz、Benchmark、Race 与回归门禁](./docs/interview/16-go-production-engineering/S-GOENG-04-fuzz-benchmark-race.md) |
| 40 | `S-GOENG-05` | [Go Modules、Workspace、Toolchain 与可复现构建](./docs/interview/16-go-production-engineering/S-GOENG-05-modules-toolchain-reproducible.md) |
| 41 | `S-GOENG-06` | [静态分析、govulncheck 与依赖供应链](./docs/interview/16-go-production-engineering/S-GOENG-06-static-analysis-supply-chain.md) |
| 42 | `S-CODE-06` | [Singleflight 缓存击穿抑制](./docs/interview/08-coding-senior/S-CODE-06-singleflight-cache.md) |
| 43 | `S-CODE-07` | [有界批处理执行器：取消、顺序与背压](./docs/interview/08-coding-senior/S-CODE-07-bounded-batch-executor.md) |
| 44 | `S-CODE-01` | [并发安全 LRU 缓存](./docs/interview/08-coding-senior/S-CODE-01-concurrent-lru.md) |
| 45 | `S-CODE-02` | [令牌桶限流器](./docs/interview/08-coding-senior/S-CODE-02-token-bucket.md) |
| 46 | `S-CODE-03` | [HTTP 服务优雅关闭](./docs/interview/08-coding-senior/S-CODE-03-graceful-shutdown.md) |
| 47 | `S-CODE-04` | [errgroup 语义实现](./docs/interview/08-coding-senior/S-CODE-04-errgroup.md) |
| 48 | `S-CODE-05` | [连接池实现要点](./docs/interview/08-coding-senior/S-CODE-05-connection-pool.md) |
...
| 51 | `S-NET-01` | [gRPC vs HTTP/REST 选型](./docs/interview/06-network-governance/S-NET-01-grpc-vs-rest.md) |
| 52 | `S-NET-02` | [HTTP 连接池与 Keep-Alive](./docs/interview/06-network-governance/S-NET-02-http-connection-pool.md) |
| 53 | `S-NET-03` | [Gin 中间件链与请求生命周期](./docs/interview/06-network-governance/S-NET-03-gin-middleware.md) |
| 54 | `S-NET-04` | [JWT 认证与安全边界](./docs/interview/06-network-governance/S-NET-04-jwt-auth.md) |
| 55 | `S-NET-05` | [WebSocket 网关设计](./docs/interview/06-network-governance/S-NET-05-websocket-gateway.md) |
| 56 | `S-DB-06` | [复杂 SQL：JOIN、CTE、窗口函数与执行计划](./docs/interview/middleware/mysql/S-DB-06-advanced-sql.md) |
| 57 | `S-DB-07` | [资金类表设计：DECIMAL、约束、锁与死锁](./docs/interview/middleware/mysql/S-DB-07-financial-schema-locking.md) |
| 58 | `S-DB-01` | [MySQL 索引原理与最左前缀](./docs/interview/middleware/mysql/S-DB-01-mysql-index.md) |
| 59 | `S-DB-02` | [事务隔离级别与 MVCC](./docs/interview/middleware/mysql/S-DB-02-transaction-mvcc.md) |
| 60 | `S-DB-03` | [慢查询排查与 EXPLAIN](./docs/interview/middleware/mysql/S-DB-03-slow-query.md) |
| 61 | `S-DB-04` | [分库分表策略与跨库查询](./docs/interview/middleware/mysql/S-DB-04-sharding.md) |
| 62 | `S-DB-05` | [GORM 预加载 N+1 与事务陷阱](./docs/interview/middleware/mysql/S-DB-05-gorm-pitfalls.md) |
| 63 | `S-PG-01` | [PostgreSQL MVCC、VACUUM、可见性与索引设计](./docs/interview/middleware/postgresql/S-PG-01-mvcc-vacuum-indexes.md) |
| 64 | `S-PG-02` | [PostgreSQL 隔离级别、锁与资金写入](./docs/interview/middleware/postgresql/S-PG-02-isolation-locking-ledger.md) |
| 65 | `S-PG-03` | [PostgreSQL WAL、复制、故障切换与 pgx 连接治理](./docs/interview/middleware/postgresql/S-PG-03-wal-replication-pgx-ha.md) |
| 66 | `S-DIST-01` | [Redis 集群模式与选型](./docs/interview/middleware/redis/S-DIST-01-redis-cluster.md) |
| 67 | `S-DIST-02` | [分布式锁与 Redlock 争议](./docs/interview/middleware/redis/S-DIST-02-distributed-lock.md) |
| 68 | `S-DIST-03` | [热点 Key 发现与治理](./docs/interview/middleware/redis/S-DIST-03-hot-key.md) |
| 69 | `S-KAFKA-01` | [Kafka 架构与存储：Topic、Partition、ISR](./docs/interview/middleware/kafka/S-KAFKA-01-architecture-storage.md) |
| 70 | `S-KAFKA-02` | [Kafka Producer 可靠性：acks、幂等与分区键](./docs/interview/middleware/kafka/S-KAFKA-02-producer-reliability.md) |
| 71 | `S-KAFKA-03` | [Kafka 交易事件总线：成交广播与 lag 治理](./docs/interview/middleware/kafka/S-KAFKA-03-trade-event-bus.md) |
| 72 | `S-DIST-04` | [Kafka 消费语义与 Rebalance](./docs/interview/middleware/kafka/S-DIST-04-kafka-semantics.md) |
| 73 | `S-RMQ-01` | [RocketMQ 架构与核心概念](./docs/interview/middleware/rocketmq/S-RMQ-01-architecture.md) |
| 74 | `S-RMQ-02` | [RocketMQ 顺序消息、事务消息与延迟消息](./docs/interview/middleware/rocketmq/S-RMQ-02-order-transaction-delay.md) |
| 75 | `S-RMQ-03` | [RocketMQ 与 Kafka 选型对比](./docs/interview/middleware/rocketmq/S-RMQ-03-vs-kafka.md) |
| 76 | `S-RMQ-04` | [RocketMQ 运维排障：堆积、重试与死信](./docs/interview/middleware/rocketmq/S-RMQ-04-ops-troubleshooting.md) |
| 77 | `S-RAB-01` | [RabbitMQ 拆分链上监听与业务写入](./docs/interview/middleware/rabbitmq/S-RAB-01-exchange-async-pipeline.md) |
| 78 | `S-ES-01` | [Elasticsearch 倒排索引与基本原理](./docs/interview/middleware/elasticsearch/S-ES-01-inverted-index.md) |
| 79 | `S-ES-02` | [Elasticsearch Mapping、查询与聚合](./docs/interview/middleware/elasticsearch/S-ES-02-mapping-query-agg.md) |
| 80 | `S-ES-03` | [Elasticsearch 数据同步与运维](./docs/interview/middleware/elasticsearch/S-ES-03-sync-ops.md) |
| 81 | `S-DIST-05` | [分布式事务 TCC vs Saga](./docs/interview/middleware/distributed/S-DIST-05-distributed-transaction.md) |
...
| 84 | `S-ARCH-03` | [分布式 ID：雪花、号段、UUID 取舍](./docs/interview/03-system-design/S-ARCH-03-distributed-id.md) |
| 85 | `S-ARCH-04` | [幂等设计：接口、消息、数据库层](./docs/interview/03-system-design/S-ARCH-04-idempotency.md) |
| 86 | `S-ARCH-05` | [最终一致 vs 强一致：业务怎么选](./docs/interview/03-system-design/S-ARCH-05-consistency-tradeoff.md) |
| 87 | `S-ARCH-06` | [缓存穿透、击穿、雪崩治理体系](./docs/interview/03-system-design/S-ARCH-06-cache-failure-modes.md) |
| 88 | `S-ARCH-07` | [多级缓存与本地缓存一致性](./docs/interview/03-system-design/S-ARCH-07-multi-level-cache.md) |
| 89 | `S-ARCH-08` | [限流：令牌桶、漏桶、分布式限流](./docs/interview/03-system-design/S-ARCH-08-rate-limiting.md) |
| 90 | `S-ARCH-09` | [熔断、降级、舱壁](./docs/interview/03-system-design/S-ARCH-09-circuit-breaker.md) |
| 91 | `S-ARCH-10` | [消息队列：至少一次、恰好一次、顺序性](./docs/interview/03-system-design/S-ARCH-10-mq-semantics.md) |
| 92 | `S-ARCH-11` | [延迟任务与定时任务架构](./docs/interview/03-system-design/S-ARCH-11-delayed-jobs.md) |
| 93 | `S-ARCH-12` | [支付/订单状态机设计](./docs/interview/03-system-design/S-ARCH-12-order-state-machine.md) |
| 94 | `S-ARCH-13` | [多活、异地容灾与 RPO/RTO](./docs/interview/03-system-design/S-ARCH-13-multi-active-dr.md) |
| 95 | `S-ARCH-14` | [微服务拆分边界与何时不该拆](./docs/interview/03-system-design/S-ARCH-14-microservice-boundary.md) |
| 96 | `S-ARCH-15` | [API 版本、灰度发布与特性开关](./docs/interview/03-system-design/S-ARCH-15-release-strategy.md) |
| 97 | `S-ARCH-16` | [可观测性：日志、指标、链路](./docs/interview/03-system-design/S-ARCH-16-observability.md) |
| 98 | `S-ARCH-17` | [SLO/SLI 与错误预算](./docs/interview/03-system-design/S-ARCH-17-slo-error-budget.md) |
...
| 205 | `S-EXCH-23` | [预测市场 CTF、Outcome Token 与市场生命周期](./docs/interview/14-dex-cex-engineering/S-EXCH-23-prediction-market-ctf-lifecycle.md) |
| 206 | `S-EXCH-24` | [CLOB-first 预测市场：EIP-712 订单与链上结算](./docs/interview/14-dex-cex-engineering/S-EXCH-24-prediction-market-clob-eip712-settlement.md) |
...
| 211 | `S-EXCH-29` | [DeFi Staking、流动性挖矿与 Yield Farming](./docs/interview/14-dex-cex-engineering/S-EXCH-29-defi-staking-liquidity-mining-yield.md) |
| 212 | `S-EXCH-30` | [Uniswap V2 与 V3 协议机制深挖](./docs/interview/14-dex-cex-engineering/S-EXCH-30-uniswap-v2-v3-protocol.md) |
| 213 | `S-EXCH-31` | [DEX Tech Lead 45 分钟架构白板](./docs/interview/14-dex-cex-engineering/S-EXCH-31-dex-tech-lead-whiteboard.md) |
...
| 216 | `S-LEAD-03` | [带团队与 Code Review 文化](./docs/interview/07-engineering-leadership/S-LEAD-03-code-review-culture.md) |
| 217 | `S-LEAD-04` | [Staff 技术战略、无职权影响力与案例表达](./docs/interview/07-engineering-leadership/S-LEAD-04-staff-strategy-influence-case.md) |
| 218 | `S-LEAD-05` | [跨团队高风险迁移、灰度切换与回滚边界](./docs/interview/07-engineering-leadership/S-LEAD-05-cross-team-migration-case.md) |
| 219 | `S-AI-01` | [Go 接入大模型 API：流式、重试、超时](./docs/interview/10-ai-engineering/S-AI-01-llm-api-integration.md) |
| 220 | `S-AI-02` | [RAG 架构：分块、向量检索与 Go 落地](./docs/interview/10-ai-engineering/S-AI-02-rag-architecture.md) |
| 221 | `S-AI-03` | [AI Agent 与 Function Calling](./docs/interview/10-ai-engineering/S-AI-03-agent-tool-calling.md) |
| 222 | `S-AI-04` | [Prompt 工程与 Context 窗口管理](./docs/interview/10-ai-engineering/S-AI-04-prompt-context.md) |
| 223 | `S-AI-05` | [LLM 应用安全：注入、PII、护栏](./docs/interview/10-ai-engineering/S-AI-05-llm-security.md) |
| 224 | `S-AI-06` | [LLM 可观测性、成本与延迟优化](./docs/interview/10-ai-engineering/S-AI-06-llm-observability-cost.md) |
| 225 | `S-AI-07` | [Go 实现 MCP Server：工具暴露与 stdio/HTTP 部署](./docs/interview/10-ai-engineering/S-AI-07-mcp-server-go.md) |
| 226 | `S-AI-08` | [多模态与语音接入：图像、音频在 Go 服务中的工程实践](./docs/interview/10-ai-engineering/S-AI-08-multimodal-voice.md) |
| 227 | `S-AI-09` | [Agent 工作流、Human-in-the-loop 与可靠发布控制面](./docs/interview/10-ai-engineering/S-AI-09-agent-workflow-hitl-publishing.md) |
| 228 | `S-AI-10` | [Persona、分层 Memory 与反馈学习治理](./docs/interview/10-ai-engineering/S-AI-10-persona-memory-feedback-governance.md) |
| 229 | `S-AI-11` | [MCP 与 A2A：Tool、Agent、任务生命周期与跨框架互操作](./docs/interview/10-ai-engineering/S-AI-11-mcp-a2a-vendor-neutral-interoperability.md) |
| 230 | `S-AI-12` | [ERC-8004：Agent 身份、信誉、验证与钱包绑定](./docs/interview/10-ai-engineering/S-AI-12-erc8004-agent-identity-reputation-validation.md) |
| 231 | `S-AI-13` | [x402、x402b 与 ERC-8183：Agent 支付、托管、争议和对账](./docs/interview/10-ai-engineering/S-AI-13-x402-erc8183-agent-commerce.md) |
| 232 | `S-AI-14` | [Crypto Agent SDK、开放平台、Marketplace 与 Launchpad 架构](./docs/interview/10-ai-engineering/S-AI-14-crypto-agent-open-platform-marketplace-launchpad.md) |
